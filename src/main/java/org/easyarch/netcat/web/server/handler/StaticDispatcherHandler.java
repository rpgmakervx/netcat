package org.easyarch.netcat.web.server.handler;

import io.netty.channel.ChannelHandlerContext;
import io.netty.handler.codec.http.*;
import org.easyarch.netcat.web.context.ActionHolder;
...
import org.easyarch.netcat.web.mvc.action.ActionType;
import org.easyarch.netcat.web.mvc.action.filter.HttpFilter;
import org.easyarch.netcat.web.mvc.action.handler.impl.StaticHttpHandler;
import org.easyarch.netcat.web.mvc.router.Router;
...
public class StaticDispatcherHandler extends BaseDispatcherHandler {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        Router router = new Router(request.uri(), ActionType.HANDLER, org.easyarch.netcat.web.http.protocol.HttpMethod.getMethod(request.method()));
